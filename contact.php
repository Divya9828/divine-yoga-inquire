  ...
  <div class="container-fluid">
    <div class="row" style="margin-top: 12%;">
      <div class="col-lg-10 col-lg-offset-1 col-md-10 col-md-offset-1 col-xs-12">
        <img src="./asset/yoga1.jpg" data-aos="fade-up" data-aos-delay="100" alt="" style="border-radius:5px ;" class="col-lg-offset-2 col-xs-offset-2 main-img">
      </div>
    </div>
    <div class="container-fluid">
      <div class="row">
        <div class="col-lg-8 col-lg-offset-2 col-md-8 col-md-offset-2 col-xs-10 col-xs-offset-1">
          <div id="head-title" data-aos="fade-up" data-aos-delay="100">
            <h3>contact</h3>
            <h5><a href="index.php">Home</a> / <a href="contact.php">contact</a></h4>
          </div>
        </div>
      </div>
    </div>
